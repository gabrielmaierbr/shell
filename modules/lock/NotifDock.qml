...
ColumnLayout {
    ...
    StyledText {
        ...
        text: Notifs.list.length > 0 ? qsTr("%1 notificaçõe%2").arg(Notifs.list.length).arg(Notifs.list.length === 1 ? "" : "s") : qsTr("Notificações")
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                StyledText {
                    ...
                    text: Config.lock.hideNotifs ? qsTr("Desbloqueie para ver as notificações") : qsTr("Sem notificações")
