...
Item {
    ...
    StyledText {
        ...
        text: (Players.active?.trackTitle ?? qsTr("Sem mídia")) || qsTr("Desconhecido")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackAlbum ?? qsTr("Sem mídia")) || qsTr("Desconhecido")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackArtist ?? qsTr("Sem mídia")) || qsTr("Desconhecido")
